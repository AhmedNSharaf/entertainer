...
class AdminDataModel {
  ...
  String shareAppLinkIOS =
      "https://apps.apple.com/in/developer/ahmad-al-mahdawi/id1651006070";
  ...
  static List<AdminDataModel> fromMapList(List<dynamic> list) {
    return list
        .map((e) => AdminDataModel.fromMap(e as Map<String, dynamic>))
        .toList();
  }
  ...
  ///region fromJson
  AdminDataModel.fromJson(String jsonInput)
  ...
  Map<String, dynamic> toMap([bool isDateIso8601String = false]) {
    return {
      ...
      if (Support_WA_number != null)
        AdminDataModelFields.Support_WA_number: Support_WA_number,
      if (Donation_WA_number != null)
        AdminDataModelFields.Donation_WA_number: Donation_WA_number,
      if (Donation_WA_Message != null)
        AdminDataModelFields.Donation_WA_Message: Donation_WA_Message,
      if (Support_WA_Message != null)
        AdminDataModelFields.Support_WA_Message: Support_WA_Message,
      if (Donation_WA_Message_ar != null)
        AdminDataModelFields.Donation_WA_Message_ar: Donation_WA_Message_ar,
      if (Support_WA_Message_ar != null)
        AdminDataModelFields.Support_WA_Message_ar: Support_WA_Message_ar,
      AdminDataModelFields.homeSliders:
          homeSliders.map((e) => e.toMap()).toList(),
      ...
      if (dateUpdated != null)
        AdminDataModelFields.dateUpdated:
            isDateIso8601String
                ? dateUpdated!.toIso8601String()
                : SuperDateConverters.toMapConversion(dateUpdated),
      if (staticMapApiKey != null)
        AdminDataModelFields.staticMapApiKey: staticMapApiKey,
      if (mapDistanceApiKey != null)
        AdminDataModelFields.mapDistanceApiKey: mapDistanceApiKey,
      if (mapPlacesApiKey != null)
        AdminDataModelFields.mapPlacesApiKey: mapPlacesApiKey,
      if (mapGeocodingApiKey != null)
        AdminDataModelFields.mapGeocodingApiKey: mapGeocodingApiKey,
      if (mapKeyDirectionsApiKey != null)
        AdminDataModelFields.mapKeyDirectionsApiKey: mapKeyDirectionsApiKey,
      if (mapDefaultPointLoad != null)
        AdminDataModelFields.mapDefaultPointLoad: mapDefaultPointLoad,
  ...
  AdminDataModel copyWith({
    ...
    return AdminDataModel()
      ...
      ..Donation_WA_Message_ar =
          Donation_WA_Message_ar ?? this.Donation_WA_Message_ar
      ..Support_WA_Message_ar =
          Support_WA_Message_ar ?? this.Support_WA_Message_ar
      ...
      ..mapKeyDirectionsApiKey =
          mapKeyDirectionsApiKey ?? this.mapKeyDirectionsApiKey
  ...
  void updateFromMap(Map<String, dynamic> map) {
    ...
    if (map[AdminDataModelFields.Support_WA_number] != null) {
      Support_WA_number =
          map[AdminDataModelFields.Support_WA_number].toString();
    }
    if (map[AdminDataModelFields.Donation_WA_number] != null) {
      Donation_WA_number =
          map[AdminDataModelFields.Donation_WA_number].toString();
    }
    if (map[AdminDataModelFields.Donation_WA_Message] != null) {
      Donation_WA_Message =
          map[AdminDataModelFields.Donation_WA_Message].toString();
    }
    if (map[AdminDataModelFields.Support_WA_Message] != null) {
      Support_WA_Message =
          map[AdminDataModelFields.Support_WA_Message].toString();
    }
    if (map[AdminDataModelFields.Donation_WA_Message_ar] != null) {
      Donation_WA_Message_ar =
          map[AdminDataModelFields.Donation_WA_Message_ar].toString();
    }
    if (map[AdminDataModelFields.Support_WA_Message_ar] != null) {
      Support_WA_Message_ar =
          map[AdminDataModelFields.Support_WA_Message_ar].toString();
    }
    if (map[AdminDataModelFields.homeSliders] != null) {
      homeSliders = BannerModel.fromMapList(
        map[AdminDataModelFields.homeSliders] as List,
      );
    }
    if (map[AdminDataModelFields.shareAppLinkAndroid] != null) {
      shareAppLinkAndroid =
          map[AdminDataModelFields.shareAppLinkAndroid] ??
          "https://play.google.com/store/apps/dev?id".toString();
    }
    if (map[AdminDataModelFields.shareAppLinkIOS] != null) {
      shareAppLinkIOS =
          map[AdminDataModelFields.shareAppLinkIOS] ??
          "https://apps.apple.com/in/developer/ahmad-al-mahdawi/id1651006070"
              .toString();
    }
    if (map[AdminDataModelFields.loadingMessage] != null) {
      loadingMessage =
          map[AdminDataModelFields.loadingMessage] ??
          "سبحان الله وبحمد\nسبحان الله العظيم".toString();
    }
    if (map[AdminDataModelFields.dateUpdated] != null) {
      dateUpdated = SuperDateConverters.tryParseDateTime(
        map[AdminDataModelFields.dateUpdated]!.toString(),
      );
    }
    ...
    if (map[AdminDataModelFields.mapDistanceApiKey] != null) {
      mapDistanceApiKey =
          map[AdminDataModelFields.mapDistanceApiKey].toString();
    }
    ...
    if (map[AdminDataModelFields.mapGeocodingApiKey] != null) {
      mapGeocodingApiKey =
          map[AdminDataModelFields.mapGeocodingApiKey].toString();
    }
    if (map[AdminDataModelFields.mapKeyDirectionsApiKey] != null) {
      mapKeyDirectionsApiKey =
          map[AdminDataModelFields.mapKeyDirectionsApiKey].toString();
    }
    if (map[AdminDataModelFields.mapDefaultPointLoad] != null) {
      mapDefaultPointLoad =
          map[AdminDataModelFields.mapDefaultPointLoad].toString();
    }
    if (map[AdminDataModelFields.mapZoomLevel] != null) {
      mapZoomLevel =
          double.tryParse(map[AdminDataModelFields.mapZoomLevel].toString()) ??
          16.0;
    }
  }
  ...
  bool isTheSameObjectID(AdminDataModel other) =>
