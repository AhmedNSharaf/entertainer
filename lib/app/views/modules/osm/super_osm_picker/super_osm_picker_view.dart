          ...
          controller.mapController == null
              ...
              : Stack(
                children: [
                  ...
                  Obx(() {
                    mPrint(
                      'selectedLocationForTooltip = ${controller.selectedLocationForTooltip}',
                    );
                    if (controller.selectedLocationForTooltip == null)
                      return const SizedBox();
                        ...
                        child: SuperDecoratedContainer(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              vSpace32,
                              Txt(
                                controller.selectedLocationForTooltip!.address,
                              ),
                              const Divider(height: 24, thickness: 2),
                              Txt(
                                'Country: ${controller.selectedLocationForTooltip!.country}',
                              ),
                              vSpace16,
                              Txt(
                                'administrativeArea: ${controller.selectedLocationForTooltip!.administrativeArea}',
                              ),
                              vSpace16,
                              Txt(
                                'subAdministrativeArea: ${controller.selectedLocationForTooltip!.subAdministrativeArea}',
                              ),
                              vSpace16,
                            ],
                          ),
